...
> getPriceRed :: (Num a, Fractional a) => Datensatz -> a
...
> isInStock (DS {sofort_lieferbare_stueckzahl = x}) = x>0
> isInStock _ = False
...
> guenstigste_Lieferanten typ lff a = maybefy $ drop2 $ trim2Min(getPriceList lfrntn typ lff a)
>   where
